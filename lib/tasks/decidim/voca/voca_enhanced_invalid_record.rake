...
VOCA_RELATION_CHECKS = [
  ...
  ["Decidim::ContentBlockAttachment", :content_block],
  ["Decidim::Newsletter", :author],
  ["Decidim::Newsletter", :organization],
  ["Decidim::ParticipatorySpaceLink", :from],
  ["Decidim::ParticipatorySpaceLink", :to],
  ["Decidim::Endorsement", :resource],
  ["Decidim::Endorsement", :author],
  ["Decidim::Follow", :followable],
  ["Decidim::Follow", :user],
  ["Decidim::Report", :moderation],
  ["Decidim::Report", :user],
  ["Decidim::ShortLink", :organization],
  ["Decidim::ShortLink", :target],
  ["Decidim::Moderation", :reportable],
  ["Decidim::Moderation", :participatory_space],
  ["Decidim::Moderation", :component],
